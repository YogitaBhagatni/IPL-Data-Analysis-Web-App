...
selected=option_menu(
  ...
  icons=["house","activity","clipboard-data"],
  menu_icon="cast",
  default_index=0,
...
if selected=="Analysis":
  ...
  if button:
       st.sidebar.audio(r'dataset/audio/IPL-theme-RMX.wav', format="audio/wav", start_time=0)
  ...
  data= pd.read_csv(r'dataset/matches.csv')
  df = pd.DataFrame(data)
