...
def pom (df):
  ...
  Pl_of_match['index'] = range(len(Pl_of_match))
...
def toss_decision (df):
  fig = px.pie(df, values=['463','293'], names=['Choose to field after winning toss','Choose to bat after winning toss'],title='Toss decision',)
  return fig
...
def toss_winner_count (df):
  ...
  toss_stats['index'] = range(len(toss_stats))
...
def m_2009 (df):
  season_2009 = df[df['Season'] == 'IPL-2009']
  Matches_winner = season_2009['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2010 (df):
  season_2010 = df[df['Season'] == 'IPL-2010']
  Matches_winner = season_2010['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2011 (df):
  season_2011 = df[df['Season'] == 'IPL-2011']
  Matches_winner = season_2011['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2012 (df):
  season_2012 = df[df['Season'] == 'IPL-2012']
  Matches_winner = season_2012['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2013 (df):
  season_2013 = df[df['Season'] == 'IPL-2013']
  Matches_winner = season_2013['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2014 (df):
  season_2014 = df[df['Season'] == 'IPL-2014']
  Matches_winner = season_2014['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2015 (df):
  season_2015 = df[df['Season'] == 'IPL-2015']
  Matches_winner = season_2015['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2016 (df):
  season_2016 = df[df['Season'] == 'IPL-2016']
  Matches_winner = season_2016['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2017 (df):
  season_2017 = df[df['Season'] == 'IPL-2017']
  Matches_winner = season_2017['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2018 (df):
  season_2018 = df[df['Season'] == 'IPL-2018']
  Matches_winner = season_2018['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
...
def m_2019 (df):
  season_2019 = df[df['Season'] == 'IPL-2019']
  Matches_winner = season_2019['winner'].value_counts()
  Matches_winner = pd.DataFrame(Matches_winner)
  Matches_winner = Matches_winner.reset_index()
  Matches_winner['index'] = range(len(Matches_winner))
  Matches_winner = Matches_winner.rename(columns={'index': 'Team', 'winner': 'Number of wins'})
